    ...
    <div class="mx-auto w-full p-4 pb-20 md:p-6 md:pb-6">
      <div class="grid grid-cols-12 gap-4 md:gap-6">
        <div class="col-span-12 space-y-6 xl:col-span-7">
          ...
          <!-- Chart -->
          <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-4 sm:px-6 sm:pt-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between">
              ...
              <div class="dropdown-menu relative h-fit" id="chart-1-drop-down">
                <button type="button" id="chart-1-drop-down-trigger" aria-haspopup="menu" aria-controls="chart-1-drop-down-menu" aria-expanded="false" class="btn-ghost">
                ...
                <div id="chart-1-drop-down-menu-popover" data-popover aria-hidden="true" class="min-w-[36px]">
                  <div role="menu" id="chart-1-drop-down-menu" aria-labelledby="chart-1-drop-down-trigger"> class="rounded-md shadow-lg bg-white dark:bg-gray-800">
                    <div role="menuitem">
                      Ver detalles
                    </div>
                    <div role="menuitem">
        ...
        <div class="col-span-12 xl:col-span-5">
          <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            <div id="appointments-bystate-chart" class="h-full pl-2 xl:min-w-full" style="min-height: 300px;"></div>
          </div>
        </div>
      </div>
    </div>
